...
describe('include-code-extension', () => {
  ...
  describe('include code', () => {
    ...
    it('should support sync-group-id', () => {
      ...
      expect(actual.convert()).to.contain('class="openblock tabs is-sync data-sync-group-id=thisisauniqueid is-loading"')
    })
    ...
    it('should support sync-group-id not defined', () => {
      ...
      expect.fail('update above line to match previous test')
    })
